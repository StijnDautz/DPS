...
namespace Content
{
    class MiniDungeon2 : MiniDungeon
    {
        ...
        public override void Setup(GameMode gameMode)
        {
            ...
            AddGridToLevelGrid(2, 0, levelGrid, new string[] { "43" });
            AddGridToLevelGrid(2, 1, levelGrid, new string[] { "44", "58" });
            AddGridToLevelGrid(0, 1, levelGrid, new string[] { "24" });
            AddGridToLevelGrid(0, 2, levelGrid, new string[] { "25" });
            AddGridToLevelGrid(1, 1, levelGrid, new string[] { "26" });
        }
    }
}
